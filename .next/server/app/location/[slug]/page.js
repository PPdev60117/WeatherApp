...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 91549)), "C:\\Users\\Acer\\Desktop\\coding\\weatherApp\\my-app\\app\\location\\[slug]\\page.tsx"],
...
locate: [
          ...
          {},
          {
            defaultPage: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.t.bind(__webpack_require__, 1762, 23)), "next/dist/client/components/parallel-route-default"],
          }
        ]
      },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 66637)), "C:\\Users\\Acer\\Desktop\\coding\\weatherApp\\my-app\\app\\layout.tsx"],
'error': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 94363)), "C:\\Users\\Acer\\Desktop\\coding\\weatherApp\\my-app\\app\\error.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 83174))).default(props))],
    apple: [],
    openGraph: [],
...
locate: [
    ...
    const pages = ["C:\\Users\\Acer\\Desktop\\coding\\weatherApp\\my-app\\app\\location\\[slug]\\page.tsx"];
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/location/[slug]/page","pathname":"/location/[slug]","bundlePath":"app/location/[slug]/page","filename":"","appPaths":[]}}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 59240))
...
/* harmony import */ var _app_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(95863);
...
function Page({ params }) {
    ...
    const size = (0,_app_page__WEBPACK_IMPORTED_MODULE_8__.useWindowSize)();
    (0,react__WEBPACK_IMPORTED_MODULE_7__.useEffect)(()=>{
        fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${params.slug}&appid=${"ec7ef657468c48e95fc618f0d1681680"}`).then((res)=>res.json()).then((data)=>{
            setSevenhour(data);
            return data;
        }).then((data)=>{
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\Acer\Desktop\coding\weatherApp\my-app\app\location\[slug]\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [669,156,693,978], () => (__webpack_exec__(7378)));
